  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col items-end pointer-events-auto">
      ...
      <motion.button
        ...
        className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-tr from-[#31326f] to-[#4fb7b3] flex items-center justify-center shadow-lg shadow-[#4fb7b3]/40 border border-white/20 z-50 group"
        data-hover="true"
      >
        {isOpen ? (
